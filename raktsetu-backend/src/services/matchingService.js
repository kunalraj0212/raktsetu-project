...
import { logMatchingTriggeredEvent } from './activityService.js';

/**
 * Core Matching Algorithm.
 * Finds all eligible, available, compatible donors for a specific emergency request.
 */
export const findEligibleDonors = async (requestId, actorId = null) => {
  ...
  logMatchingTriggeredEvent({
    actorId,
    requestId: request._id,
    matchCount: eligibleDonors.length,
  });
