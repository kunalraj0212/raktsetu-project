            ...
            <section className="section">
                <div className="container about-mission-grid">
                    <div className="about-mission">
                        ...
                        <h2>Our Mission</h2>
                        <p>To ensure no life is lost due to the unavailability of blood in India. RaktSetu aims to bridge the gap between blood availability and demand through technology, making the entire process transparent, efficient, and accessible to everyone.</p>
                    </div>
                    <div className="about-story">
                        <div className="mission-icon-wrap"><Award size={32} /></div>
                        <h2>Our Story</h2>
                        <p>Born out of the realization that India faces a chronic shortage of blood — with an annual deficit of nearly 10 million units — RaktSetu was created to solve this crisis through digital innovation. We connect donors, patients, and blood banks on a single, unified platform.</p>
                    </div>
                </div>
            </section>
